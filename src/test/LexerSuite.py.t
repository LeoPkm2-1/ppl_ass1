...
#         """test string 1"""
#         self.assertTrue(TestLexer.test("\"ahihi xin chao\"","ahihi xin chao,<EOF>",121))
...
#         # input="\"abc    afas^&*\""
#         # expect="\"abc    afas^&*\",<EOF>"
#         self.assertTrue(TestLexer.test("\"abc    afas^&*\"","abc    afas^&*,<EOF>",123))
...
#         """test string 5"""
#         input=""" "abc def """
#         expect="""Illegal Escape In String: abc def  """
